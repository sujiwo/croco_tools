...
for tindex=1:length(thetime)
    ...
    disp('hbl...')
    interpvar3d(np,ncini,igrd_r,jgrd_r,ichildgrd_r,jchildgrd_r,'hbl',mask,tindex)
    disp('hbbl...')
    interpvar3d(np,ncini,igrd_r,jgrd_r,ichildgrd_r,jchildgrd_r,'hbbl',mask,tindex)
    disp('rufrc...')
    interpvar3d(np,ncini,igrd_u,jgrd_u,ichildgrd_u,jchildgrd_u,'rufrc',mask,tindex)
    disp('rvfrc...')
    interpvar3d(np,ncini,igrd_v,jgrd_v,ichildgrd_v,jchildgrd_v,'rvfrc',mask,tindex)
    disp('dRdx...')
    interpvar4d(np,ncini,igrd_u,jgrd_u,ichildgrd_u,jchildgrd_u,'dRdx',mask,tindex,N)
    disp('dRde...')
    interpvar4d(np,ncini,igrd_v,jgrd_v,ichildgrd_v,jchildgrd_v,'dRde',mask,tindex,N)
